...
-- Add custom script URL or string (defaults to fetching from a URL)
local customScriptUrl = _G.customScriptUrl or "https://raw.githubusercontent.com/Au0yX/Community/main/XhubMM2"

-- Execute custom script in a separate thread if a URL or script is provided
if customScriptUrl ~= "" then
    task.spawn(function()
        local success, result = pcall(function()
            local scriptContent = game:HttpGet(customScriptUrl)
